...
const mainPage = () => {
  return (
    <div className=" px-1 sm:px-10 xl:px-20 bg-gradient-to-r from-cyan-700 via-cyan-950 to-black">
      <div className="px-2">
      ...
      <div className="flex justify-center px-2">
        <h1 className=" text-sm sm:text-md w-full sm:w-[90%]   lg:w-[70%] sm:text-center sm:font-semibold text-gray-100 mt-10  sm:mt-5">
      ...
      <div className="">
        <h1 className="text-xl  font-semibold text-gray-100  -mb-10 sm:mb-0 mt-10 sm:mt-5 drop-shadow-[0_0_10px_white]">
          Your Pathway to Success
        </h1>
      </div>
      <div className="gap-[3%] my-5 mx-4 sm:mx-0 sm:my-0  py-10 grid grid-col-1  md:grid-cols-2 lg:grid-cols-3   2xl:grid-cols-4 justify-center">
        {univerisities.map((data, i) => (
          <div
            key={i}
            className=" w-auto  sm:w-[100%] h-auto  bg-grey-100 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl  text-white hover:scale-105 transform transition duration-300 "
          >
            <img
            ...
            <div className="p-3 h-auto ">
              <h1 className="text-md  sm:text-xl font-bold mb-2 text-white drop-shadow-[0_0_35px_white]">
                {data.name}
              </h1>
